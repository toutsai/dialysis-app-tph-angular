    ...
    logbookEvents.forEach((event) => {
      ...
      if (!processedPatientIds.has(pid)) {
        ...
        sheetData.history.push({
          ...
          '21 腎臟超音波檢驗日期': toRocDate(h['renalUltrasoundDate'] as string),
          '22 其他系統性疾病': mapCheckboxes(h['selectedSystemicDiseases'] as number[], 15),
          ...
          '36 其他症狀': mapCheckboxes(h['selectedSymptoms'] as number[], 15),
          '37 其他症狀(其他)': h['symptomsOtherDescription'] || '',
          '38 緊急透析原因': mapCheckboxes(h['selectedEmergencyReasons'] as number[], 20),
